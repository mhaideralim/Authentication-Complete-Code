...
from v1.database.db_connection import get_database
from v1.models.authentication_model import User, VerifyEmail, VerifyOTP, VerifyForgotOTP
from v1.utils.utilities import SECRET_KEY, ALGORITHM, smtp_server, port, sender_email, sender_password
